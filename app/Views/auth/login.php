...
<body class="bg-background-light dark:bg-background-dark text-[#0d121b] dark:text-white min-h-screen">
    <div class="flex min-h-screen w-full flex-col lg:flex-row">
        ...
        <div class="relative hidden lg:flex lg:w-1/2 flex-col justify-center items-center bg-primary p-12 overflow-hidden">
            ...
            <div class="relative max-w-md text-center">
                ...
                <p class="text-white/80 text-lg mb-8">
                    Our community has generated over <span class="text-white font-bold">$2.4M in passive income</span> using our AI-driven insights this month.
                </p>
                <!-- Success Metric Card -->
                <div class="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 text-left shadow-2xl">
                    <div class="flex items-center gap-4 mb-4">
                        <div class="size-12 rounded-full bg-cover bg-center" data-alt="Portrait of a successful entrepreneur" style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuAgJPa6yBfQwLpWYukhibyqYdeu2fskrFy6DDBNJNBGDW3drx7lY9Yj4c5Ucbfq3i5mczYGy-ShvBlkhGVrRY3xjC17qny5zUmE7-cZJ0S3Q4JL9LtDm56vSV9y9DhesQ1785IR4i5s56d5fSgrFbx85WppSk1qCO-5yI4gogQprocKHuXMrKHUb5fOHiXT6RhXJuYoLcxwCiPtHswkzUwpt09PYKXJlxy65B1xcrpLggrota0myLnxV_6SH3Hy4hAvO2zNetM9EEjT');"></div>
                        <div>
                            <p class="text-white font-bold">Alex Rivera</p>
                            <p class="text-white/60 text-xs">Community Member</p>
                        </div>
                    </div>
                    <p class="text-white/90 italic">"The AI Hub analytics helped me scale my workflow 5x. Best investment of the year."</p>
                </div>
            </div>
        ...
        <div class="flex flex-1 flex-col justify-center px-6 py-12 lg:px-24 bg-background-light dark:bg-background-dark">
            <div class="mx-auto w-full max-w-[480px]">
                ...
                <header class="mb-10 flex flex-col items-start gap-4">
                    ...
                    <h1 class="text-[#0d121b] dark:text-white text-3xl font-black leading-tight tracking-tight sm:text-4xl">
                        Welcome back
                    </h1>
